...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($id) {
            ...
            $user_detailsupdate = Employee_detail::where(array('emp_id'=>$id));
			...
			/// updated a user controller  fdgdfrgdfg jhjbjbjmbmbmb
        /*if ($user->emp_id) {
